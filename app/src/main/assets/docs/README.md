...
Version 2.5.6. Kotlin and Jetpack Compose for the app, JavaScript for the console
and editor.
...
[`PyCmd-2.5.6.apk`](dist/PyCmd-2.5.6.apk), open it on the phone, and allow the
