...
Version 2.5.5. Kotlin and Jetpack Compose for the app, JavaScript for the console
and editor.
...
[`PyCmd-2.5.5.apk`](dist/PyCmd-2.5.5.apk), open it on the phone, and allow the
